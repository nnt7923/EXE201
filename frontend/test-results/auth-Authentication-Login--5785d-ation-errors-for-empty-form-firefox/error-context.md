...
- generic [ref=e1]:
  - generic [ref=e2]:
    - link "Quay về trang chủ" [ref=e3] [cursor=pointer]:
      - /url: /
      - button "Quay về trang chủ" [ref=e4]:
        - img
    ...
    - generic [ref=e5]:
      ...
      - generic [ref=e10]:
        - generic [ref=e11]:
          ...
          - paragraph [ref=e18]: Vui lòng nhập email và mật khẩu.
        - button "Đăng nhập" [active] [ref=e19] [cursor=pointer]
      - paragraph [ref=e21]:
